...
const LandingPage = () => {
  ...
  // State for platform stats, initialized with loading placeholders
  ...
  // Fetch platform-wide stats on mount
          ...
          <div className="hero-visual">
            ...
            <div className="security-dashboard">
              ...
              <div className="dashboard-header">
                ...
                <div className="dashboard-title">Platform Activity</div>

                <div className="dashboard-status">🟢 Live Data</div>

              </div>

              <div className="dashboard-content">

                {/* Display dynamic platform stats */}

                <div className="security-metric">

                  <span className="metric-label">Vulnerabilities Found</span>

                  <span className="metric-value success">{platformStats.vulnerabilitiesFound}</span>

                </div>

                <div className="security-metric">

                  <span className="metric-label">APIs Secured</span>

                  <span className="metric-value">{platformStats.apisSecured}</span>
                ...
                <div className="security-metric">
                  ...
                  <span className="metric-value">{platformStats.scansToday}</span>
