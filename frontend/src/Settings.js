      ...
      try {
        ...
        try {
          ...
          const preferencesResponse = await axios.get(
            ...
            'https://apithreatassessment.co.za/api/user/preferences',
        ...
        try {
          ...
          const extendedResponse = await axios.get(
            ...
            'https://apithreatassessment.co.za/api/user/extended-profile',
    ...
    try {
      ...
      if (activeTab === 'profile') {
        ...
        const profileResponse = await makeApiCall(
          ...
          'https://apithreatassessment.co.za/api/user/update',
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      const response = await makeApiCall(
        ...
        'https://apithreatassessment.co.za/api/user/password',
                    ...
                    <div className="form-group">
                      ...
                      <div className="form-group">
                          ...
                          <select
                            ...
                            // Read value from and write value to the global context
