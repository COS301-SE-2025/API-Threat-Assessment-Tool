...
//   // Mock Google login method in Login component or user event
//   // For example, mock the handler to call window.alert directly:
//   const googleLoginBtn = screen.getByText(/Continue with Google/i);
